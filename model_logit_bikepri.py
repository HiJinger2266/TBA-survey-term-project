...
X["youbike_alterbike"] = df_old["youbike_alterbike"]
X["youbike_station"] = df_old["youbike_station"]
X["bike_no_leisure"] = df_old["bike_no_leisure"]

print(X.columns)

#In[3]
X_train, X_test, y_train, y_test = train_test_split(X, y_bikepri, test_size=0.2, random_state=0)
'''
print(X_train)
print(y_train)
print(X_test)
