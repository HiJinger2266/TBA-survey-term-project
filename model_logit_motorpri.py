...
X["motor_flex"] = df_old["motor_flex"]
X["motor_everyone"] = df_old["motor_everyone"]
X["motor_no_danger"] = df_old["motor_no_danger"]

print(X.columns)

#In[3]
X_train, X_test, y_train, y_test = train_test_split(X, y_motorpri, test_size=0.2, random_state=0)
'''
print(X_train)
print(y_train)
print(X_test)
